...
#define WHEEL_DIAMETER          0.084135 // diameter of wheel in meters
#define WHEEL_BASE              0.1572  // wheel separation distance in meters
#define MAX_FWD_VEL             0.8   // maximum forward speed (m/s)
#define MAX_TURN_VEL            2.5   // maximum turning speed (rad/s)
#define OPEN_LOOP_LEFT_Y_INT    0.131/1.29
#define OPEN_LOOP_LEFT_Y_SLOPE  1/1.29
#define OPEN_LOOP_RIGHT_Y_INT   0.109/1.2
#define OPEN_LOOP_RIGHT_Y_SLOPE 1/1.2
...
#define SLAM_POSE_CHANNEL           "SLAM POSE"
