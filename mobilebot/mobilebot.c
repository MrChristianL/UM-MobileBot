...
void read_mb_sensors(){
    ...
    // Read encoders    
    mb_state.left_encoder_delta = rc_encoder_read(LEFT_MOTOR)*LEFT_ENC_POL;
    mb_state.right_encoder_delta = rc_encoder_read(RIGHT_MOTOR)*RIGHT_ENC_POL;
...
void publish_mb_msgs(){
    ...
    //odometry_t_publish(lcm, SLAM_POSE_CHANNEL, &odo_msg);
}
